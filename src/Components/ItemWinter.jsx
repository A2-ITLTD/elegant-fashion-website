...
import menwinter2 from '../ItemsImage/menwinter2.jpg';
import menwinter3 from '../ItemsImage/menwinter3.jpg';
import menwinter4 from '../ItemsImage/menwinter4.jpg';
import menwinter5 from '../ItemsImage/menwinter5.jpg';
import menwinter6 from '../ItemsImage/menwinter6.jpg';

import womenwinter1 from '../ItemsImage/womenwinter1.jpg';
import womenwinter2 from '../ItemsImage/womenwinter2.jpeg';
import womenwinter3 from '../ItemsImage/womenwinter3.jpeg';
import womenwinter4 from '../ItemsImage/womenwinter4.jpg';
import womenwinter5 from '../ItemsImage/womenwinter5.jpg';
import womenwinter6 from '../ItemsImage/womenwinter6.jpg';

import kidwinter1 from '../ItemsImage/kidwinter1.jpg';
import kidwinter2 from '../ItemsImage/kidwinter2.jpg';
import kidwinter3 from '../ItemsImage/kidwinter3.jpg';
import kidwinter4 from '../ItemsImage/kidwinter4.jpg';
import kidwinter5 from '../ItemsImage/kidwinter5.jpg';
import kidwinter6 from '../ItemsImage/kidwinter6.jpg';
        ...
        <div className="mt-14 px-5 md:px-10 lg:px-24" >
           <div className='text-center text-5xl font-semibold pb-10'>
            ...
            <div className='mt-10 grid grid-cols-2 md:grid-cols-5 gap-10 px-5 md:px-24'> 
                ...
                <Link to="/Tshits" className='relative w-40 h-40 rounded-full'>
                    <img src={mentshirt1} className='w-full h-full object-cover object-center rounded-full' />
                    <div className="absolute inset-0 rounded-full bg-black opacity-50 hover:opacity-80"></div>
                    <h1 className="absolute text-white text-center text-3xl font-bold bottom-14 left-8">T-shirt</h1>
                </Link>
