...
const ItemShorts = () => {
    ...
    useEffect(() => {
        ...
        .then(res => res.json())
        .then(data => {
            const filterdata = data.filter(item => item.category === "shorts"); 
        ...
        .then(res => res.json())
        .then(data => {
            const filterdata2 = data.filter(item => item.category === "shorts"); 
        ...
        .then(res => res.json())
        .then(data => {
            const filterdata3 = data.filter(item => item.category === "shorts"); 
